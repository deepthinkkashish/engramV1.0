...
interface ProcessingContextType {
    ...
    startProcessing: (userId: string, topicId: string, files: FileList) => Promise<string | null>;
...
export const ProcessingProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const startProcessing = useCallback(async (userId: string, topicId: string, files: FileList): Promise<string | null> => {
